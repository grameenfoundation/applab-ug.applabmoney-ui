							...
							<c:forEach items="${ussdMenuItemsList}" var="menuitem">
								<tr class=data>
									<c:if test="${menuitem.menuItemId != 0}">
										<td class=data><a
											href="/applabmoneyaui/editussdmenuitem/${menuitem.menuItemId}.html">${menuitem.menuItemName}</a>
										</td>
										...
										<td class=data><c:if
												...
												<a
													href="/applabmoneyaui/activatemenuitem/${menuitem.menuItemId}.html">Activate</a>
											</c:if> <c:if test="${menuitem.menuItemEnabledFlag == 1}">
												<a
													href="/applabmoneyaui/deactivatemenuitem/${menuitem.menuItemId}.html">Deactivate</a>
											</c:if> <a
											href="/applabmoneyaui/removemenuitem/${menuitem.menuItemId}.html">Delete</a>
										</td>
									</c:if>
								</tr>
							</c:forEach>
