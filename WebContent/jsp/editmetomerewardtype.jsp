			...
			<tr>
				<td class="content">
					<div>
						<fieldset>
							<legend>
								<h2>Create New MetoMe Reward Type</h2>
							</legend>
							...
							<form:form method="post"
								...
								<table>
									<tr>
										<td class="formlabels"><form:label path="rewardTypeId">Me2Me Reward Type ID:</form:label>
										</td>
									...
									<tr>
										<td class="formlabels"><c:if
												test="${meToMeRewardType.cashRewardFlag == 1}">
												<form:checkbox cssClass="otherformfields"
													path="cashRewardFlag" value="1" checked="true" />
