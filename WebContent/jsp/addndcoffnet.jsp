			...
			<tr>
				<td class="content">
					<div>
						<fieldset>
							<legend>
								<h2>Create New Allowed Mobile NDC - OFFNET</h2>
							</legend>

							<form:form method="post" action="addndcoffnet.html"
								...
								<table>
									...
									<tr>
										...
										<td class="form"><form:label path="enabledFlag">Enable Offnet NDC</form:label>
										</td>
									</tr>
									<tr>
										<td></td>
