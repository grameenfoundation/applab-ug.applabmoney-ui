...
<body>
	...
	<div>
		<div>
			<table style="width: 100%;">
				<tr>
					<td><h2>Transaction Send Limits</h2>
						<hr></td>
				</tr>
			</table>
		</div>
						...
						<tr>
							...
							<td><div>
									<input class="btn" type="submit" name="submit"
										value="Create New"
										onClick="location.href='addglobalsendlimit.html'">
								</div>
							</td>
						</tr>
					</table> <c:if test="${empty globalSendLimitList}">
						<div>
							<table>
								<tr>
									<td>There are no Global Send Limits configured on this
										system <br> <br>
									</td>
								</tr>
							</table>
						</div>
					</c:if> <c:if test="${!empty globalSendLimitList}">
						<h2>System Global Send Limit</h2>
						<table class="data">
							<tr>
								<th>No</th>
							...
							<c:forEach items="${globalSendLimitList}" var="sendlimit"
								varStatus="status">
								<tr class=data>
									<td class="data"><a
									...
									<td class=data><c:forEach items="${accountTypesList}"
											var="accountType">
											<c:if
												test="${accountType.accountTypeId == sendlimit.accountType.accountTypeId}">
									...
									<td class=data><c:forEach
											...
											<c:if
												test="${transkeyword.keywordId == sendlimit.transactionKeyword.keywordId}">
									...
									<td class=data>${sendlimit.minTransactionAmount}</td>
									<td class=data>${sendlimit.maxTransactionAmount}</td>
									<td class=data>${sendlimit.maxAmountDay}</td>
									<td class=data>${sendlimit.maxAmountMonth}</td>
