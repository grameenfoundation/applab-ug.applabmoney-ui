					...
					<div>
						<fieldset>
							...
							<form:form method="post"
								...
								<table>
									<tr>
										<td class="formlabels"><form:label path="memoGroupId">Memo Group ID:</form:label>
										</td>
									...
									<tr>
										...
										<td class="form"><form:input cssClass="formfields"
												path="memoGroupCode" value="${memoGroup.memoGroupCode}" />
										</td>
									</tr>
									...
									<tr>
										...
										<td class="form"><form:input cssClass="formfields"
												path="memoGroupName" value="${memoGroup.memoGroupName}" />
										</td>
									</tr>
									<tr>
