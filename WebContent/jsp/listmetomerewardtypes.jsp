					...
					<table>
						...
						<table class="data">
							...
							<c:forEach items="${memoGroupsList}" var="memogroup">
								<tr class=data>
									<td class=data><a
										href="/applabmoneyaui/editmemogroup/${memogroup.memoGroupId}.html">${memogroup.memoGroupName}</a>
									</td>
									...
									<td class=data><c:if test="${memogroup.enabledFlag != 1}">
											<a
												href="/applabmoneyaui/activatememogroup/${memogroup.memoGroupId}.html">Activate</a>
										</c:if> <c:if test="${memogroup.enabledFlag == 1}">
											<a
												href="/applabmoneyaui/deactivatememogroup/${memogroup.memoGroupId}.html">Deactivate</a>
										</c:if> <a
										href="/applabmoneyaui/removememogroup/${memogroup.memoGroupId}.html">Delete</a>
									</td>
								</tr>
							</c:forEach>
						</table>
