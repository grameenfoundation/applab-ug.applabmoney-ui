			...
			<tr>
				<td class="content">
					<div>
						<fieldset>
							<legend>
								<h2>Create New Allowed Mobile NDC - P2P</h2>
							</legend>

							<form:form method="post" action="addndcptop.html"
								commandName="ndcListPToP">
								...
								<table>
									...
									<tr>
										...
										<td class="form"><form:label path="enabledFlag">Enable P2P NDC</form:label>
										</td>
									</tr>
									<tr>
										<td></td>
