					...
					<table>
						...
						<table class="data">
							...
							<c:forEach items="${meToMeGoalTypesList}" var="metomegoaltype">
								<tr class=data>
									<td class=data><a
										href="/metomeui/editmetomegoaltype/${metomegoaltype.goalTypeId}.html">${metomegoaltype.goalTypeName}</a>
									</td>
									<td class=data>${metomegoaltype.goalTypeCode}</td>
									<td class=data>${metomegoaltype.goalTypeDescription}</td>
									<td class=data><a
										href="/metomeui/removemetomegoaltype/${metomegoaltype.goalTypeId}.html">Delete</a>
									</td>
								</tr>
							</c:forEach>
						</table>
					...
					<table>
						...
						<table class="data">
							...
							<c:forEach items="${meToMeRewardTypesList}"
								...
								<tr class=data>
									<td class=data><a
										href="/metomeui/editmetomerewardtype/${metomerewardtype.rewardTypeId}.html">${metomerewardtype.rewardTypeName}</a>
									</td>
									<td class=data>${metomerewardtype.rewardTypeCode}</td>
									<td class=data>${metomerewardtype.rewardTypeDescription}</td>
									<td class=data><a
										href="/metomeui/removemetomerewardtype/${metomerewardtype.rewardTypeId}.html">Delete</a>
									</td>
								</tr>
							</c:forEach>
						</table>
