						...
						<tr>
							...
							<td><div>
									<input class="btn" type="submit" name="submit"
										value="Create New"
										onClick="location.href='addglobalkeywordcharge.html'">
								</div>
							</td>
						</tr>
					</table> <c:if test="${empty globalKeywordChargeList}">
						<div>
							<table>
								<tr>
									<td>There are no Global Keyword Charges configured on this
										system <br> <br>
									</td>
								</tr>
							</table>
						</div>
					</c:if> <c:if test="${!empty globalKeywordChargeList}">
						<h2>System Global Keyword Charges</h2>
						<table class="data">
							<tr>
								<th>No</th>
								<th>Charge Transaction Keyword</th>
								<th>Charge Range</th>
								<th>Charge Fixed</th>
								<th>Charge Percent</th>
								<th>Action</th>
							</tr>
							<c:forEach items="${globalKeywordChargeList}" var="charge"
								varStatus="status">
								<tr class=data>
									<td class="data"><a
										href="/applabmoneyaui/editglobalkeywordcharge/${charge.chargeId}.html">${status.count}</a>
									</td>
									...
									<td class=data><a
										href="/applabmoneyaui/removeglobalkeywordcharge/${charge.chargeId}.html">Delete</a>
								</tr>
							</c:forEach>
						</table>
					</c:if>
