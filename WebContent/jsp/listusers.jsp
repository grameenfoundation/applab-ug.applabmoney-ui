						...
						<tr>
							...
							<td><div>
									<input class="btn" type="submit" name="submit"
										value="Create New" onClick="location.href='adduser.html'">
								</div></td>
						</tr>
					</table> <c:if test="${empty usersList}">
						<tr>
							<td>There are no users configured on this system</td>
						</tr>
						<br>
						<br>
					</c:if> <c:if test="${!empty usersList}">
						<h3>System Users</h3>
						<table class="data">
							<tr>
								<th>UserName</th>
							...
							<c:forEach items="${usersList}" var="user">
								<tr class=data>
									...
									<td class=data><a
										href="/applabmoneyaui/edituser/${user.userId}.html">Edit</a>&nbsp;|&nbsp;<a
										href="/applabmoneyaui/removeuser/${user.userId}.html">Delete</a>
									</td>
								</tr>
							</c:forEach>
						</table>
