			...
			<tr>
				<td class="content">
					<div>
						<fieldset>
							<legend>
								<h2>Edit New MetoMe Goal Type</h2>
							</legend>
							...
							<form:form method="post"
								...
								<table>
									<tr>
										<td class="formlabels"><form:label path="goalTypeId">Me2Me Goal Type ID:</form:label>
										</td>
									...
									<tr>
										...
										<td class="form"><form:input cssClass="formfields"
												path="goalTypeCode" value="${meToMeGoalType.goalTypeCode}" />
										</td>
									</tr>
									<tr>
										<td class="formlabels"><form:label path="goalTypeName">Me2Me Goal Type Name: </form:label>
										</td>
										<td class="form"><form:input cssClass="formfields"
												path="goalTypeName" value="${meToMeGoalType.goalTypeName}" />
										</td>
									</tr>
									<tr>
										<td class="formlabels"><form:label
												path="goalTypeDescription">Me2Me Goal Type Description: </form:label>
										</td>
										<td class="form"><form:input cssClass="formfields"
